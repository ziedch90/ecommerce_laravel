                                    ...
                                    <ul class="mega-menu">
                                        <li>
                                            <ul>
                                                ...
                                                <li class="mega-menu-title"><a href="{{route("front.products",$category->id)}}">{{$category->name}}</a></li>
                                        ...
                                        <li>
                                            <ul>
                                                <li class="mega-menu-img"><a href="shop.html"><img src="{{asset('assets/img/banner/banner-12.png')}}" alt=""></a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                       ...
                       <div class="header-right-wrap">
                        ...
                        <div class="same-style cart-wrap">
                            <button class="icon-cart">
                                ...
                                <span class="count-style">@if (session()->has('panier')) {{ count(session()->get('panier'))}} @else{{0}}@endif </span>
                            ...
                            <div class="shopping-cart-content">
                                <ul>
                                    ...
                                    @forelse ( session()->get("panier") as $product )
                                    @php
                                        $total+=$product['price']*$product['qty'];
                                    @endphp
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt="" src="{{asset('images/produits/'.$product['photo'])}}" width="50"></a>
                                        </div>
                                ...
                                <div class="shopping-cart-total">
                                    ...
                                    <h4>Total : <span class="shop-total">{{$total}} TND</span></h4>
                                </div>
                                <div class="shopping-cart-btn btn-hover text-center">
                                    <a class="default-btn" href="{{route('front.panier.list')}}">view cart</a>
