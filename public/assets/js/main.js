//add to cart
function addtocart(id,name,price,qty,photo){
    var token= $('meta[name="csrf-token"]').attr('content');
    $.ajax({
        type: 'POST',
        url:"/front/panier/store",
        data: {_token:token,id:id,name:name,price:price,qty:qty,photo:photo},

    success: function(Response) {
        console.log(Response);
        $(".count-style").html(Response.length);
        //afficher la drop-down panier la nouvelle liste dans le paniers
        $(".shopping-cart-content ul").html("");
       var html="";
        var tot=0;
        Response.forEach(product => {
html+= '<li class="single-shopping-cart"><div class="shopping-cart-img"><a href="#"><img alt="" src="/images/produits/'+product.photo+'" width="50"></a></div><div class="shopping-cart-title"><h4><a href="#">'+product.name+' </a></h4><h6>Qty:'+product.qty+' </h6> <span>'+product.price+' TND</span></div><div class="shopping-cart-delete"><a href="#"><i class="fa fa-times-circle"></i></a></div></li>';
tot+=product.price*product.qty;
        });
        $(".shopping-cart-content ul").html(html);
        $(".shop-total").html(tot);
    }
});
}
